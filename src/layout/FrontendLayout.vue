<script setup>
 ...
 import Special_deals from '@/components/templateParts/frontend/Special_deals.vue';


const route = useRoute()

// Pages that should not show slider and featured products
const EXCLUDED_ROUTES = ['category', 'subcategory', 'productdetailspage', 'login', 'registration', 'viewcart', 'checkout', 'user_account', 'order_details', 'search_results']
