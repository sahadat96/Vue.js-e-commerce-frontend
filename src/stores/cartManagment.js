        ...
        actions: {
            async addToCart(cartItem) {
              try {
                ...
                const response = await axiosClient.post('/api/addtocart', cartItem, {
                  headers: { 
            ...
            async fetchCartItems() {
              ...
              try {
                ...
                const response = await axiosClient.get('/api/getcart', {
                  headers: {
                    'Authorization': `Bearer ${token}`,
            ...
            async removeCartItem(cartId) {
              try {
                ...
                await axiosClient.delete(`/api/cartdelete/${cartId}`, {
                  headers: {
                    'Authorization': `Bearer ${token}`,
                    'Accept': 'application/json'
                  }
