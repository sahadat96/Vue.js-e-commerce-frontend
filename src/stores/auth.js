...
export const useAuthStore = defineStore('auth', {
    ...
    actions: { 
        ...
        async login(formData) {
            try {
                const response  = await axiosClient.post('/api/userlogin', formData, {
                    headers: {
        ...
        async registration(formData){
            try {
                const response  = await axiosClient.post('/api/userregistration', formData, {
                    headers: {
                        'Content-Type' : 'application/json',
                        'Accept': 'application/json',
                    },
        ...
        async logout(){
         ...
         async getUser(){
            try {
                const response = await axiosClient.get('/api/getauthuser', {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('token')}`,
                        'Accept': 'application/json',
                    }
