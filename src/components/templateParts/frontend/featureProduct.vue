...
const getProducts = async () => {
    try {
        const response = await axiosClient.get("/api/getallproducts");
        products.value = response.data.getProduct.data;
        links.value = response.data.getProduct.links;

        if (products.value.product_image && products.value.product_image.length > 0) {
            mainImage.value = products.value.product_image[0];
            productImages.value = products.value.product_image;
       }
    } catch (err) {
...
const changePage = async (link) => {
    ...
    try {
        const response = await axiosClient.get(link.url);
        products.value = response.data.getProduct.data;
        links.value = response.data.getProduct.links;
    } catch (err) {
        error.value = err.message;
            ...
            <div class="product-item" v-for="product in products" :key="product.id">
                <div class="product-cart-wrap mb-30">
                    <div class="product-img-action-wrap">
                        <div class="product-img product-img-zoom">
                            <a @click="productDetails(product.id)" >
                                <img class="default-img" :src="getImageUrl(`/uploads/product/product_photo/${product.product_image}`)" alt=""/>
                                <img class="hover-img" :src="getImageUrl(`/uploads/product/product_photo/${product.product_image}`)" alt="" />
                            </a>
                        </div>
                        <div class="product-action-1">
                            <a aria-label="Add To Wishlist" class="action-btn" href="#"> <i class="bi bi-heart"></i></a>
                            <a aria-label="Compare" class="action-btn" href="#"><i class="bi bi-shuffle"></i></a>
                    ...
                    <div class="product-content-wrap">
                        ...
                        <h2><a @click="productDetails(product.id)">{{ product.product_name }}</a></h2>
                            ...
                            >
                                <div class="detail-gallery">
                                    ...
                                    >
                                        ...
                                        >
                                            <img
                                                :src="getImageUrl(`/uploads/product/productgallery/${image}`)"
                                                :alt="
