...
<template>
   ...
   <header class="header-area header-style-1 header-height-2">
        ...
        <div class="mobile-promotion" >
            <span @click="Home()">cheaprategallery.com</span>
        </div>
                ...
                <div class="row align-items-center">    
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            <ul>
                                <li>Need help? Call Us: <strong class="text-brand">+88 01841715878</strong></li>
                                <li>
                            ...
                            <div class="header-action-2">
                                ...
                                <div v-if="isAuthenticated" class="header-action-icon-2">
                                    <a class="mini-cart-icon" href="">
                                        <img alt="" :src="getImageUrl('/frontend/assets/imgs/theme/icons/icon-cart.svg')" />
                                        ...
                                        <ul >
                                            <li v-for="cartItem in cartItems" :key="cartItem.id">
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.html"><img alt="Nest" :src="getImageUrl(`/uploads/product/product_photo/${cartItem.image}`)" /></a>
                                                </div>
                                  ...
                                  <div class="header-action-icon-2" v-if="isAuthenticated">
                                        <a href="#">
                                            <img class="svgInject" alt="Nest" :src="getImageUrl('/frontend/assets/imgs/theme/icons/icon-user.svg')"  />
                                        </a>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    <div class="logo logo-width-1 d-block d-lg-none">
                        <a href="#"><img :src="getImageUrl('/frontend/assets/imgs/theme/icons/logo.jpg')"  alt="logo" /></a>
                    </div>
                                       
                    <div class="header-nav d-none d-lg-flex">
                        <div class="main-categori-wrap d-none d-lg-block">
                            <a class="categories-button-active" >
                                <span class=""></span> Cheap Rate Gallery
                            </a>
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    ...
                                    <ul class="end">
                                        <li>
                                            <a href="shop-grid-right.html"> <img :src="getImageUrl('/frontend/assets/imgs/theme/icons/category-6.svg')" alt="" />Wines & Drinks</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="more_slide_open" style="display: none">
                                    <div class="d-flex categori-dropdown-inner">
                                        <ul>
                                            <li>
                                                <a href="shop-grid-right.html"> <img :src="getImageUrl('/frontend/assets/imgs/theme/icons/icon-1.svg')" alt="" />Milks and Dairies</a>
                                            </li>
                                            
                                        </ul>
                                        <ul class="end">
                                            <li>
                                                <a href="shop-grid-right.html"> <img :src="getImageUrl('/frontend/assets/imgs/theme/icons/icon-3.svg')"  alt="" />Wines & Drinks</a>
                                            </li>
                                ...
                                <div class="header-action-2" v-if="isAuthenticated">
                                    ...
                                    <div class="header-action-icon-2">
                                        <a class="mini-cart-icon">
                                            <img :src="getImageUrl('/frontend/assets/imgs/theme/icons/icon-cart.svg')"  />
                                    ...
                                    <div class="header-action-icon-2">
                                                <a href="#">
                                                    <img class="svgInject" alt="" :src="getImageUrl('/frontend/assets/imgs/theme/icons/icon-user.svg')"  />
                                                </a>
                                                <a href="#"><span class="lable ml-0">Account</span></a>
                                                <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                                    <ul>
