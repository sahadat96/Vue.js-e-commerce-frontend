...
const getProduct = async () => {
    try {
        const response = await axiosClient.get(`/api/getproductdetails/${route.params.id}`);
                                        ...
                                        >
                                            <swiper-slide v-for="image in products.get_image" :key="image.id">
                                                <div class="swiper-zoom-container">
                                                    <img 
                                                        :src="getImageUrl(`/uploads/product/productgallery/${image.images}`)" 
                                    ...
                                    <div class="tab-style3">
                                        ...
                                        <div class="tab-content shop_info_tab entry-main-content">
                                            <div class="tab-pane fade show active" id="Description">
                                                <div class="">
                                                    <h5>Short Description : <p>{{ products.short_desc }}</p> </h5> 
                                                    ...
                                                    <h5>Long Description : 
                                                     ...
                                                     <br>
                                                    <h5>Operator Phone Number : <p>{{ products.operator_phone }} </p> </h5>
