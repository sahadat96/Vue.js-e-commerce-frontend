...
const fetchOrderDetails = async () => {
   ...
   try {
        const response = await axiosClient.get(`/api/getOrderDetails/${route.params.orderId}`, {
            headers:{
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr v-for="item in orderItems" :key="item.id">
                          <td>
                           <img :src="getImageUrl(`/uploads/product/product_photo/${item?.img}`)" class="img-fluid" style="width: 80px; height: 80px;" > 
                          </td> 
