...
const fetchSearchResults = async () => {
  ...
  try {
    ...
    const response = await axiosClient.get('/api/search_products', { 
      params: { 
...
const changePage = async (link) => {
    ...
    try {
        ...
        // Update products, links, and current page
        products.value = response.data.getProduct.data;
        links.value = response.data.getProduct.links;
        currentPage.value = response.data.getProduct.current_page;
...
<template>
    <section class="product-tabs section-padding position-relative">
        ...
        <h5 class="page-title">Results for "{{ searchQuery }}"</h5>
